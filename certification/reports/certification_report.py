...
class CertificationReport(models.Model):
    ...
    _auto = False
    #_auto: Needs to be defined as False due to when creating a new model, Odoo wil (by default)l create a new table.
    # By positioning this class attribute to False, we manage the table ourselves.
